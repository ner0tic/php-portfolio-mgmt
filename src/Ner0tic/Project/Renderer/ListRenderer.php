...
/**
 * Renders ProjectItem tree as unordered list
 */
class ListRenderer extends Renderer implements RendererInterface
{
    ...
    protected function renderList( ItemInterface $item, array $attributes, array $options )
    {
         ...
         *   a ) The project has no children eligible to be displayed
         *   b ) The depth is 0
         *   c ) This project item has been explicitly set to hide its children
         */
    ...
    /**
     * Renders all of the children of this project.
     *
     * This calls ->renderItem() on each project item, which instructs each
     * project item to render themselves as an <li> tag ( with nested ul if it
     * has children ).
    ...
    /**
     * Called by the parent project item to render this project.
     *
     * This renders the li tag to fit into the parent ul as well as its
     * own nested ul tag if this project item has children
     *
     * @param ItemInterface $item
     * @param array         $options The options to render the item
     *
    ...
    protected function renderItem( ItemInterface $item, array $options )
    {
        ...
        $childrenClass[] = 'project_level_'.$item->getLevel();
     ...
     * makes up its part in a fully-rendered and spaced project.
     *
